import { HiCheck, HiX, HiPhotograph, HiFingerPrint, HiOfficeBuilding, HiChip, HiTrendingUp } from 'react-icons/hi';
                    ...
                    {isPending ? (
                        <>
                            <button
                                ...
                                title={isRankUpgrade ? "Authorize Rank Upgrade" : "Authorize Capital"}
                            >
